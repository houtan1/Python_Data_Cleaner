...
# import dataset
dset = pd.read_table(path, index_col=False)

lengths = dset.loc[:, "Length (mm)"]

name, params = best_fit_distribution(lengths)
print(name)
print(params)
...
lengths.plot(kind='hist', bins=50, normed=True, alpha=0.5, label='Data', legend=True, ax=ax)
